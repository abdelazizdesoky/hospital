...
{
  public $invoicessaved,$invoicesupdated;
  public $doctor_id,$patient_id,$price,$discount_value=0,$Service_id,$type,$single_invoice_id;
  public $tax_rate=15;
       ...
       //invoice cach ---------------------------------------------------------
        if ( $this->type==1){
            ...
            if($this->updateMode){
                ...
                $fund_accounts = FundAccounts::where('invoice_id',$this->single_invoice_id)->first();
