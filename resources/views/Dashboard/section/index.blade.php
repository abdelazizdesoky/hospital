...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">{{trans('Dashboard/section_tran.sections')}}|</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">{{trans('Dashboard/section_tran.all')}}</span>
						</div>
					</div>
				...
				<div class="row row-sm">
					<div class="col-xl-12">
						<div class="card">
                         ...
                         <button type="button" class="btn btn-primary data-effect="effect-scale"  data-toggle="modal" href="#add">{{trans('Dashboard/section_tran.add')}}</button>
									<div class="card-body">
