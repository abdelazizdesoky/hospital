    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">{{trans('Dashboard/section_tran.edit')}}</h5>
            ...
            <form action="{{ route('sections.update','test') }}" method="post">
                ...
                <div class="modal-body">
                    <label for="exampleInputPassword1">{{trans('Dashboard/section_tran.section')}}</label>
